  ...
  return (
    <div className="p-10 max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        >
          <button className="w-full flex items-center gap-3 px-4 py-3 bg-surface text-accent rounded-xl shadow-sm border border-primary-100 font-medium text-sm transition-all">
          ...
          <div className="glass-card p-8">
            ...
            <div className="space-y-5">
              ...
              <div className="pt-4 flex justify-end">
                <button className="flex items-center gap-2 px-6 py-2.5 bg-accent text-primary-950 rounded-lg font-medium text-sm hover:bg-primary-900 transition-colors shadow-sm">
          ...
          <div className="glass-card p-8">
            ...
            <div className="flex gap-4">
              <div className="flex-1 p-4 border border-primary-100 rounded-xl bg-primary-950 flex items-center justify-center cursor-pointer hover:border-primary-300 transition-colors">
                <span className="font-medium text-primary-100 text-sm">Light Mode</span>
              </div>
              <div className="flex-1 p-4 border-2 border-accent rounded-xl bg-surface flex items-center justify-center cursor-pointer relative overflow-hidden">
                <div className="absolute top-2 right-2 w-4 h-4 bg-accent rounded-full border-2 border-surface flex items-center justify-center">
                  <div className="w-1.5 h-1.5 bg-surface rounded-full"></div>
                </div>
                <span className="font-medium text-accent text-sm">Dark Mode (Active)</span>
              </div>
            </div>
          </div>
        </motion.div>
